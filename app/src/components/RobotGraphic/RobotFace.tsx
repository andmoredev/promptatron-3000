...
type RobotFaceColors = Record<string, string>

/**
 * RobotFace component that renders different facial expressions using SVG
 */
const RobotFace = ({ expression, animated = true, size = 'md', theme: propTheme }: RobotFaceProps) => {
  ...
  const baseColors: RobotFaceColors = {
 ...
 */
const renderHappyExpression = (_scale: number, animated: boolean, colors: RobotFaceColors): ReactElement => (
 ...
 */
const renderThinkingExpression = (_scale: number, animated: boolean, colors: RobotFaceColors): ReactElement => (
 ...
 */
const renderTalkingExpression = (_scale: number, animated: boolean, colors: RobotFaceColors): ReactElement => (
 ...
 */
const renderConcernedExpression = (_scale: number, animated: boolean, colors: RobotFaceColors): ReactElement => (
