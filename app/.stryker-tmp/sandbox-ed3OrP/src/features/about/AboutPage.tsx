 ...
 * links, same landmarks; only the typing and the tabpanel wiring changed.
 */
// @ts-nocheck
    ...
    <div className="space-y-6 sm:space-y-8 max-w-5xl mx-auto" data-testid="about-page">
      <section className="card" aria-labelledby="principles-heading">
        ...
        <p className="text-sm sm:text-base text-gray-600 mb-6">
          These principles guide effective AI agent development and prompt engineering for reliable,
          scalable systems.
        </p>
          ...
          {aiPrinciples.map((principle) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-700 leading-snug">{principle.description}</p>
              </div>
            </article>
          ))}
        </div>
